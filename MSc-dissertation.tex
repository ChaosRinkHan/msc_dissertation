...
The true value of parameters that are used to generate synthetic data is listed in Appendix B.1. These true values are firstly obtained by fitting a least square fit of model 1 onto the experimental data. The target data [FIGURE HERE] (synthetic data) is then generated using these parameter values via ODE solver in \verb|Python|.
